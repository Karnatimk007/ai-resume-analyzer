...
import { User, Mail, Lock, AlertCircle, FileText } from 'lucide-react';
      ...
      <div className="glass-panel w-full max-w-md p-8 rounded-3xl shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1 text-center">
            Sign up to start optimizing your resume structure
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full gradient-btn py-3.5 rounded-xl text-sm font-semibold flex items-center justify-center disabled:opacity-50 disabled:pointer-events-none mt-4"
          >
            {isSubmitting ? (
